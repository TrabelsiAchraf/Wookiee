...
//  
//
//  Created by Achraf Trabelsi on 12/05/2022.
//

import Foundation

public let movie1 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie2 = FetchedMovie(
    id: UUID().uuidString,
    title: "Pulp Fiction",
...
public let movie3 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie4 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie5 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie6 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie7 = FetchedMovie(
    id: UUID().uuidString,
    title: "Batman Begins",
...
public let movie8 = FetchedMovie(
    id: UUID().uuidString,
...
public let movie9 = FetchedMovie(
    id: UUID().uuidString,
    title: "Coco",
...
public let movie10 = FetchedMovie(
    id: UUID().uuidString,
    title: "Taxi Driver",
...
public let movie11 = FetchedMovie(
    id: UUID().uuidString,
...
public let fakeMovies: [FetchedMovie] = [
